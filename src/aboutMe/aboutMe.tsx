                ...
                <div className={`${styleContainer.container} ${style.myProjectsContainer}`}>
                    {isMobile ? (
                        <Swiper pagination={true} spaceBetween={50} slidesPerView={1}>
                            ...
                            <SwiperSlide>
                                <div style={{ marginTop: "0px", width: "300px", height: "auto", padding: "10px", color: "white", backgroundColor: "black" }}>
                            ...
                            <SwiperSlide>
                                <div style={{ marginTop: "0px", width: "300px", height: "400px", padding: "10px", color: "white", backgroundColor: "black" }}>
                                    <h3>{t("asPerson")}</h3>
                                    <div>{t("Personal")}</div>
                                </div>
                            </SwiperSlide>
