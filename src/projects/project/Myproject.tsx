    ...
    return (
        <div className={style.myProject}>
            <div className={style.imageData}>
                <img className={style.image} src={props.image} alt={props.projectTitle} style={{ width: imageSize, height: imageSize }} />
                <div>
                    <div style={{ marginLeft: "140px", color: "white" }}>{props.date}</div>
            ...
            <div className={style.overlay}>
                <div className={style.projectInfo}>
                    {showMore && <span className={style.description}>{props.projectDescription}</span>}
                    <div className={style.buttonsContainer}>
                        ...
                        <button className={`${style.button} ${style.codeButton}`} onClick={() => window.open(props.codeUrl, '_blank')}>
                            {t("viewCode")}
                        </button>
                    </div>
                </div>
